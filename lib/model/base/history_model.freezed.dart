...
abstract class $HistoryModelCopyWith<$Res> {
  ...
  $Res call({String? event, String? content, String? regdate, int? step});
}
...
class _$_HistoryModel implements _HistoryModel {
  _$_HistoryModel({this.event, this.content, this.regdate, this.step});
  ...
  @override
  String toString() {
    return 'HistoryModel(event: $event, content: $content, regdate: $regdate, step: $step)';
  }
...
abstract class _HistoryModel implements HistoryModel {
  factory _HistoryModel(
      ...
      final String? content,
      final String? regdate,
      final int? step}) = _$_HistoryModel;
